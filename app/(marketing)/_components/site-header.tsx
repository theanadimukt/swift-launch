...
export function SiteHeader() {
  ...
  return (
    <nav className={`sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-3 group">
            <div className="relative">
              <div className="w-12 h-12 bg-primary text-white rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                <Zap className="h-7 w-7 text-black" />
              </div>
              <div className="absolute -top-1 -right-1 w-4 h-4 bg-primary text-white/80 rounded-full border-2 border-white"></div>
            </div>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <div className="flex items-center space-x-8">
              ...
              <div className="relative group">
                <Link href="#features" className="flex items-center space-x-1 text-muted-foreground hover:text-foreground transition-colors font-medium group">
                  ...
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-primary text-white group-hover:w-full transition-all duration-300"></span>
                </Link>
                ...
                <div className="absolute top-full left-0 mt-2 w-64 bg-card rounded-xl shadow-xl border border-border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0">
                  <div className="p-4 space-y-3">
                    <Link href="#" className="flex items-center space-x-3 p-2 rounded-lg hover:bg-muted transition-colors">
                      <div className="w-8 h-8 bg-primary text-white/10 rounded-lg flex items-center justify-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-primary text-white rounded-full border-2 border-background"></div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <Button
                  className="bg-primary hover:bg-primary text-white/90 text-black font-semibold px-6 py-2.5 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                >
          ...
          <div className="lg:hidden mt-4 pb-4 border-t border-border pt-4">
            <div className="space-y-4">
              ...
              <div className="border-t border-border pt-4 space-y-3">
                ...
                <Button
                  className="w-full bg-primary hover:bg-primary text-white/90 text-black font-semibold shadow-lg"
                >
                  Get Started
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
      ...
      <div className="bg-primary text-white text-black text-center py-3">
